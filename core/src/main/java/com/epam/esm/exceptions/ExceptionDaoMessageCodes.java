...
public class ExceptionDaoMessageCodes {
    ...
    public static final String NO_ENTITY_WITH_NAME = "504003";
    public static final String SAVING_ERROR = "504004";
    public static final String ACCESS_TO_RESOURCE_LIMITED = "504000";
}
